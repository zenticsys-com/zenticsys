...
import AutomotiveAccordionItems from "../_components/AutomotiveAccordionItems";

const AutomotiveWebAccordion = () => {
  return (
...
export default AutomotiveWebAccordion;
