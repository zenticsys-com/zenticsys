  ...
  const faqs = [
    {
      ...
      answer: "Initial consultations usually last 30-60 minutes, depending on project complexity."
    },
    {
      question: "Is the consultation free?",
      answer: "Yes, we offer free initial consultations to understand your needs and explore how we can help."
    },
    {
      question: "What happens after the consultation?",
      answer: "We'll provide a detailed proposal with timeline, costs, and next steps within 48 hours."
    },
    {
    ...
    },
    {
      ...
      answer: "Come prepared with your project goals, timeline, budget range, and any existing documentation or requirements."
    },
    {
      question: "Can we schedule follow-up meetings?",
      answer: "Yes, we're happy to schedule additional meetings as needed throughout the project planning and development process."
    }
  ];
  ...
  const processSteps = [
    {
      ...
      description: 'We discuss your project requirements, goals, and challenges to understand your needs.'
    },
    {
      icon: <Target className="w-8 h-8 text-[#ef3d23]" />,
      title: 'Solution Design',
      description: 'Our experts create a tailored solution proposal with timeline and cost estimates.'
    },
    {
      icon: <Users className="w-8 h-8 text-[#ef3d23]" />,
      title: 'Team Assembly',
      description: 'We assign the right team members with the expertise needed for your project.'
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              ...
              Schedule a free consultation with our experts to discuss your project and explore possibilities.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="space-y-8">
            ...
            <Card className="border-none shadow-lg bg-[#ef3d23] text-white">
              <CardContent className="p-6">
                <h3 className="text-xl font-semibold mb-4">Need to Talk Right Now?</h3>
                <p className="text-red-100 mb-4">
                  Have an urgent project or need immediate consultation? Give us a call!
                </p>
                <Button 
                  variant="outline"
                  className="w-full border-white text-white hover:bg-white hover:text-[#ef3d23]"
                >
