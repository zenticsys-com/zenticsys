          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Build the future of software with a passionate team of
                innovators. At Zenticsys, we're not just developing software –
                we're shaping the digital transformation of businesses
                worldwide.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                We foster a collaborative, inclusive environment where
                innovation thrives. Our team is our greatest asset, and we're
                committed to creating a workplace where everyone can grow,
