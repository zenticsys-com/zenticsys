  ...
  const services = [
    {
      ...
      description: 'Tailored solutions built to meet your specific business requirements and objectives. We create scalable, maintainable software that grows with your business.',
    ...
    },
    {
      ...
      description: 'Native and cross-platform mobile applications for iOS and Android that deliver exceptional user experiences and drive engagement.',
      features: ['iOS & Android development', 'Cross-platform solutions', 'App Store optimization', 'Offline functionality'],
      technologies: ['React Native', 'Flutter', 'Swift', 'Kotlin']
    },
    {
      icon: <Cloud className="w-12 h-12 text-primary" />,
      title: 'Cloud Solutions',
      description: 'Scalable cloud infrastructure and migration services for modern businesses looking to leverage the power of cloud computing.',
    ...
    },
    {
      ...
      description: 'Transform your data into actionable insights with advanced analytics solutions and business intelligence platforms.',
    ...
    },
    {
      ...
      description: 'Comprehensive security solutions to protect your digital assets and data from evolving cyber threats.',
    ...
    },
    {
      ...
      description: 'Modern, responsive web applications that provide seamless user experiences across all devices and platforms.',
      features: ['Responsive design', 'Progressive Web Apps', 'E-commerce platforms', 'CMS development'],
      technologies: ['React', 'Vue.js', 'WordPress', 'Shopify']
    },
    {
      icon: <Users className="w-12 h-12 text-primary" />,
      title: 'IT Consulting',
      description: 'Strategic technology consulting to help you make informed decisions about your IT infrastructure and digital initiatives.',
      features: ['Technology assessment', 'Architecture design', 'Project planning', 'Risk management'],
    ...
    },
    {
      ...
      features: ['API development', 'Data synchronization', 'Workflow automation', 'Legacy integration'],
  ...
  const caseStudies = [
    {
      ...
      solution: 'Developed a comprehensive healthcare management platform with patient portals, appointment scheduling, and electronic health records.',
      results: ['50% reduction in admin time', '30% improvement in patient satisfaction', '99.9% system uptime'],
    ...
    },
    {
      ...
      client: 'RetailMax',
      challenge: 'Modernize outdated e-commerce platform to improve user experience and increase sales',
      solution: 'Complete platform redesign with modern UI/UX, improved performance, and advanced analytics capabilities.',
      results: ['75% increase in conversion rate', '40% faster page load times', '60% growth in mobile sales'],
    ...
    },
    {
      ...
      client: 'InvestPro',
      challenge: 'Create real-time financial analytics platform for investment professionals',
      solution: 'Built a sophisticated analytics dashboard with real-time data processing, advanced charting, and custom reporting.',
      results: ['Real-time data processing', '90% faster report generation', 'Advanced predictive analytics'],
    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              ...
              From custom development to digital transformation, we have the expertise to deliver results.
            </p>
            <Button 
              variant="contained"
              size="large"
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Real-world examples of our successful projects</p>
          </div>
      ...
      <section className="py-20 bg-primary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white mb-6">Let's Build Your Solution Together</h2>
